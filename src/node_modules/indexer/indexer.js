...
function indexFile(code, file, verbose)
{
    ...
    function add(name, locations, scope) {
        ...
        var i;
        var defObj = { location: locations[0], definition: true, name: name, references: [] };
        var newDef = true;
        if (locations[0][2] === 0) {
            ...
            for (var idx=scope.scopeStack.length - 1; idx>=0; --idx) {
                ...
                if (def) {
                    if (def.location[2] === 0) {
                        ...
                        defObj = def;
                        break;
                    } else if (def.location[2] < defObj.location[2]) {
                        newDef = false;
                        defObj = def;
                    }
                }
        ...
        while (i < locations.length) {
            ...
            var obj = { location: loc, name: name, target: defObj.location };
...
function findLocation(symbols, offset) {
    ...
    while (min <= max) {
        ...
        case 1:
            ...
            break;
        default:
            console.log("Found symbol", symbols[cur]);
            return symbols[cur];
        }
    }
    return undefined;
